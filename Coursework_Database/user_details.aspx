                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="USER_ID" DataSourceID="SqlDataSource1" AllowPaging="True" CssClass="table table-bordered">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="User Role" SortExpression="USERROLE">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("USERROLE") %>'></asp:TextBox>
                                <asp:RequiredFieldValidator
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("USERROLE") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:FormView ID="FormView1" runat="server" DataKeyNames="USER_ID" DataSourceID="SqlDataSource1">
                    ...
                    <InsertItemTemplate>
                        <div class="form-view">
                            ...
                            <asp:RequiredFieldValidator
                                ID="RequiredFieldValidatorUserID"
                                runat="server"
                            ...
                            <asp:TextBox ID="USERROLETextBox" runat="server" Text='<%# Bind("USERROLE") %>' />
                            <asp:RequiredFieldValidator
                                ID="RequiredFieldValidatorUserRole"
                                runat="server"
                                ControlToValidate="USERROLETextBox"
                                ErrorMessage="User Role is required"
                                ForeColor="Red" />
                            <br />
                            ...
                            <asp:TextBox ID="USEREMAILTextBox" runat="server" Text='<%# Bind("USEREMAIL") %>' />
                            <asp:RequiredFieldValidator
                                ID="RequiredFieldValidatorUserEmail"
                                runat="server"
